      ...
      <div className="max-w-md mx-auto p-4 -mt-5 relative z-10">
        <div className="bg-white rounded-2xl p-4 mb-4" style={{ boxShadow: '0 8px 24px rgba(0,0,0,0.08)' }}>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-gray-700">Pendampingan Administrasi</p>
              <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
                DOKB berperan sebagai jembatan dan pendamping administrasi bagi pengemudi dalam menyiapkan
                kelengkapan pengajuan KP ASK.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center space-y-1">
          <p className="text-xs font-bold text-gray-500">Sistem Pendampingan Administrasi KP ASK</p>
          <p className="text-xs text-gray-600 font-semibold">DOKB — Perkumpulan Driver Online Kalimantan Selatan Bersatu</p>
          <p className="text-[10px] text-gray-400 mt-2 leading-relaxed">
            DOKB berperan sebagai jembatan dan pendamping administrasi pengajuan.<br />
      ...
      <div className="max-w-md mx-auto p-4 -mt-4 relative z-10 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-4" style={{ boxShadow: '0 4px 16px rgba(0,0,0,0.06)' }}>
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-sm font-bold text-gray-700">Dokumen yang Perlu Disiapkan</p>
          </div>
          <p className="text-xs text-gray-400 mb-3">Siapkan seluruh dokumen berikut sesuai arahan dalam proses pengajuan KP ASK.</p>
          <div className="space-y-3">
            {DOKUMEN_LIST.map(d => (
              <div key={d.key}>
        ...
        <div className="bg-white rounded-2xl p-4" style={{ boxShadow: '0 4px 16px rgba(0,0,0,0.06)' }}>
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              ...
              keperluan pendataan, pemeriksaan kelengkapan, dan fasilitasi pengajuan Kartu Pengawasan
              Angkutan Sewa Khusus (ASK) melalui DOKB sesuai ketentuan yang berlaku.
            </p>
          </label>
        </div>
    ...
    >
      ...
      >
        ...
        <p className="text-gray-500 text-sm mb-2 leading-relaxed">
          Terima kasih! Pengajuan Kartu Pengawasan Anda telah diterima melalui sistem
          pendampingan administrasi DOKB.
        </p>
        <p className="text-gray-400 text-xs mb-8">
          Data dan dokumen akan mengikuti proses pemeriksaan serta kewenangan instansi yang berwenang.
        </p>
